...
parser.add_argument('-p', '--path', type=str, default='/data/RL_project/pytorch-vsumm-reinforce-master/log/summe-split0/result.h5', help="path to h5 result file")
parser.add_argument('-d', '--frm-dir', type=str, default='/data/RL_project/pytorch-vsumm-reinforce-master/datasets/eccv16_dataset_summe_google_pool5.h5', help="path to frame directory")
