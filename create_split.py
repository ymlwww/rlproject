...
parser.add_argument('--save-dir', type=str, default='dataset', help="path to save output json file (default: 'datasets/')")
...
parser.add_argument('--train-percent', type=float, default=0.1, help="percentage of training data (default: 0.8)")
...
def create():
    ...
    saveto = osp.join(args.save_dir, args.save_name + '_small.json')
